...
@class AVAsset, AVPlayer, AVPlayerItem, AVPlayerItemVideoOutput, NSArray, NSDate, NSError, NSString, NSTimer, NSURL, TPAVPlayerLayerView, TPFBKVOController, TPPlayerLayerViewContainer, TPPlayerVideo;

@interface TPAVPlayer : NSObject <AVPlayerItemOutputPullDelegate, TPAVPlayerLayerViewDelegate, ITPAVPlayer>
{
    _Bool isCaching;
