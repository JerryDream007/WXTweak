...
@interface WCFinderToolbarTableViewCell : UITableViewCell <WCFinderFeedToolbarActionDelegate, WCFinderFeedRetryToolBarDelegate, WCFinderFeedUploadingToolBarDelegate, WCFinderFeedContentVMExt, WCFinderFeedNotRealNameToolbarViewDelegate>
{
    ...
    UIView *_bottomLine;
    unsigned long long _feedUIStyle;
}

+ (double)cellHeightWithStyle:(unsigned long long)arg1 andContentVM:(id)arg2 width:(double)arg3;
@property(nonatomic) unsigned long long feedUIStyle; // @synthesize feedUIStyle=_feedUIStyle;
...
@property(nonatomic) _Bool isLeftShowTimeOnly; // @synthesize isLeftShowTimeOnly=_isLeftShowTimeOnly;
