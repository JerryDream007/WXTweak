...
- (void)onDownloadTaskCompletion:(long long)arg1 taskUrl:(NSString *)arg2 filePath:(NSString *)arg3 protocol:(unsigned long long)arg4 totalLength:(unsigned long long)arg5;
