...
@interface GameCenterMsgMgr : MMService <IFunctionMsgExt, MMServiceProtocol, IMsgExt, MMImageLoaderObserver>
{
    _Bool shouldClearDb;
...
- (void)reportMsgRevoke:(id)arg1 hasReceivedMsg:(_Bool)arg2;
- (void)reportCoverNotify:(id)arg1 OldMsg:(id)arg2 NewCoverOld:(_Bool)arg3;
- (void)statMsgReceived:(id)arg1 hasReceivedMsg:(_Bool)arg2;
