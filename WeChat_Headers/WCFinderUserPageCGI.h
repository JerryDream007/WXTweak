...
- (void)createRequest;
- (id)initWithContactUsername:(id)arg1 maxTid:(unsigned long long)arg2 reportScene:(unsigned long long)arg3 firstPageMd5:(id)arg4 needFansCount:(_Bool)arg5 lastBuffer:(id)arg6 successful:(CDUnknownBlockType)arg7 failure:(CDUnknownBlockType)arg8;
