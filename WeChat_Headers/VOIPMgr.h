...
@interface VOIPMgr : MMService <AVVideoDataSource, AUAudioDataSource, IAUAudioDeviceExt, ISysCallCheckExt, IVOIPSyncExt, PBMessageObserverDelegate, INetworkStatusMgrExt, CNetworkStatusExt, MMServiceProtocol, AVVideoDeviceSessionDelegate>
{
    ...
    int localVideoWith;
    int remoteVideoWith;
    _Bool mUseIOSLocalRendering;
    _Bool mUseIOSRemoteRendering;
    ...
    AVSampleBufferDisplayLayer *videoLocalDisplayLayer;
    AVSampleBufferDisplayLayer *videoRemoteDisplayLayer;
    AVSampleBufferDisplayLayer *videoSmallLocalDisplayLayer;
    AVSampleBufferDisplayLayer *videoSmallRemoteDisplayLayer;
...
@property(nonatomic) _Bool mEnableIOSRendering; // @synthesize mEnableIOSRendering;
...
@property(nonatomic) _Bool mUseIOSRemoteRendering; // @synthesize mUseIOSRemoteRendering;
@property(nonatomic) _Bool mUseIOSLocalRendering; // @synthesize mUseIOSLocalRendering;
@property(retain, nonatomic) AVSampleBufferDisplayLayer *videoSmallRemoteDisplayLayer; // @synthesize videoSmallRemoteDisplayLayer;
@property(retain, nonatomic) AVSampleBufferDisplayLayer *videoSmallLocalDisplayLayer; // @synthesize videoSmallLocalDisplayLayer;
@property(retain, nonatomic) AVSampleBufferDisplayLayer *videoRemoteDisplayLayer; // @synthesize videoRemoteDisplayLayer;
@property(retain, nonatomic) AVSampleBufferDisplayLayer *videoLocalDisplayLayer; // @synthesize videoLocalDisplayLayer;
...
- (void)StartNetDetect;
- (_Bool)getIsTalked;
- (_Bool)getIsIOSRemoteRendering;
- (_Bool)getIsIOSLocalRendering;
...
- (void)StartTalk;
- (void)tryStartTalk;
- (void)renderFrameIOSMethod:(struct __CVBuffer *)arg1 VideoLayer:(id)arg2;
- (void)remoteVideoRendering:(char **)arg1 decData:(struct __CVBuffer *)arg2 width:(int)arg3 height:(int)arg4 useHardDecData:(_Bool)arg5;
- (void)localVideoRendering:(char **)arg1 width:(int)arg2 height:(int)arg3;
- (int)updateRendering:(int)arg1 OrginalWidth:(int)arg2 State:(_Bool)arg3 IsLocalVideo:(_Bool)arg4;
- (void)isIOSRenderingUpdateMirror:(int)arg1 height:(int)arg2;
