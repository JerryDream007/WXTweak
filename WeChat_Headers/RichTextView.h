...
@interface RichTextView : MMCPLabel <TextLayoutDelegate, WCForceTouchPreviewProtocol, WCForceTouchTriggerLongPressProtocol, MMRichTextCoverViewDelegate>
{
    ...
    _Bool _shouldHiddenMoreAtEndOfText;
...
@property(nonatomic) _Bool shouldHiddenMoreAtEndOfText; // @synthesize shouldHiddenMoreAtEndOfText=_shouldHiddenMoreAtEndOfText;
...
- (_Bool)shouldAppendMoreAtEndOfText;
- (_Bool)shouldOpenNewLineAtY:(double)arg1 withLineHeight:(double)arg2;
- (double)lineWidthAtY:(double)arg1 lineIndex:(long long)arg2;
