...
@interface AudioSender : MMService <AMRAudioRecorderDelegate, SPXAudioRecorderDelegate, SilkAudioRecorderDelegate, MMNewVoiceInputCacheLogicDelegate, UploadVoiceDelegate, MMServiceProtocol>
{
