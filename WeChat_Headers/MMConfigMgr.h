...
@interface MMConfigMgr : MMService <MMPackageDownloadMgrExt, MMServiceProtocol, MMKernelExt, IMMLanguageMgrExt, IMsgExt>
{
...
- (long long)getMultiECModeLevel:(_Bool)arg1;
...
- (long long)getEngineAgcDnGainTHR;
- (long long)getEngineAgcCompRatio;
