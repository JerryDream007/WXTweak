...
@class FinderPreloadGlobalInfo, NSMutableArray, NSMutableDictionary, NSObject, NSString, WCFinderDownloadVideoCDNTask;
...
- (id)getCurrentDownloadTaskWithClientID:(id)arg1;
