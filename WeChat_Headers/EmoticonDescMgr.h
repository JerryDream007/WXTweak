...
@interface EmoticonDescMgr : MMService <EmoticonDescRecommandLogicDelegate, IEmoticonPackageMgrExt, MMServiceProtocol, PBMessageObserverDelegate, IMMLanguageMgrExt>
{
