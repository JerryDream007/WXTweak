...
@class NSArray, NSDictionary, NSMutableArray, NSString, UINavigationController, WAAppTansitionController, WAAppTaskExtInfo, WAAppTaskLoader, WACacheVersionChecker, WAContact, WALoadingViewController, WAPackageConfig, WAPermissionHandler, WAWebViewController, WOAPPrivacyConfirmLogic;
