...
@interface AddFriendEntryViewController : MMUIViewController <MMWebViewDelegate, MMTableViewInfoDelegate, InviteFriendLogicDelegate>
{
...
- (id)init;
- (void)reloadData;
- (void)onClickSearchCell:(struct WCTableViewNormalCellManager *)arg1;
