...
- (void)notifyOnCompleteExtension:(_Bool)arg1 errorCode:(unsigned int)arg2 errorMsg:(id)arg3 pkgUrl:(id)arg4 moduleName:(id)arg5 usePatch:(_Bool)arg6 protocol:(unsigned long long)arg7;
