...
@class BTOftenReadBizCache, BrandSessionCache, BrandTimelineMsgDB, MMBaseSessionStorage, MMTimer, MemoryMappedKV, NSData, NSMutableArray, NSObject, NSString;
@protocol OS_dispatch_queue;

@interface BrandTimelineMsgMgr : MMService <IMMNewSessionMgrFilterExt, WXGImportMessageNotification, MMSessionRefreshExt, IMsgExt, IMMNewSessionMgrExt, IContactMgrExt, MMKernelExt, PBMessageObserverDelegate, MMTipsViewControllerDelegate, MMImageLoaderEventNotification, MMServiceProtocol, MMImageLoaderObserver>
{
...
- (void)setTimelineMsgExposedInMainSessionWithRowIndex:(unsigned int)arg1;
...
- (id)getTimelineUnbrowsedMsgBySequenceId:(unsigned long long)arg1 limit:(unsigned int)arg2;
...
- (void)reportMainSessionDigestExpose:(id)arg1 unReadCount:(unsigned int)arg2 position:(unsigned int)arg3;
...
- (void)realTryResortTimelineIfNeed:(unsigned long long)arg1;
...
- (void)onMainSessionExposedWithRowIndex:(unsigned int)arg1;
