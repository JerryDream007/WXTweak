...
#import "MinimizeBaseViewDelegate-Protocol.h"
#import "MinimizeDraggableTaskViewDelegate-Protocol.h"
#import "MinimizeTaskOuterContentViewDelegate-Protocol.h"
#import "MinimizeTaskStateViewDelegate-Protocol.h"
#import "WCActionSheetDelegate-Protocol.h"

@class MinimizeAbsorbFloatingView, MinimizeGestureCircleView, MinimizeTaskOuterContentView, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIScrollView, UIView;
@protocol MinimizeDetailTaskListViewInterface, MinimizeTaskDataSource, MinimizeVCDelegate;

@interface MinimizeViewController : MMUIViewController <MinimizeDraggableTaskViewDelegate, MinimizeTaskStateViewDelegate, WCActionSheetDelegate, CAAnimationDelegate, MinimizeTaskOuterContentViewDelegate, MinimizeBaseViewDelegate, MinimizeAbsorbFloatingViewDelegate>
{
    _Bool _isAnimating;
...
- (void)onTaskStateViewTouched:(id)arg1 EnterTaskScene:(int)arg2;
...
- (void)onOuterContentViewTouched:(id)arg1 EnterTaskScene:(int)arg2;
