...
@interface VideoEncodeMgr : MMService <MMServiceProtocol>
{
...
- (id)startNewTaskForAsset:(id)arg1 inputPath:(id)arg2 outputPath:(id)arg3 params:(id)arg4 isHighPriority:(_Bool)arg5 configVideoComposition:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
...
- (id)getParamsForFinderAlbumVideoSize:(struct CGSize)arg1 duration:(double)arg2 fps:(float)arg3 videoBitrate:(float)arg4 audioSampleRate:(float)arg5 audioChannel:(unsigned int)arg6 audioBitrate:(float)arg7;
- (id)getParamsForFinderAlbumVideo:(id)arg1 withDuration:(double)arg2;
