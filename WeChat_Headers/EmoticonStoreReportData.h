...
+ (void)ReportClickEmoticonFromDesc:(id)arg1 expId:(id)arg2 index:(unsigned int)arg3 md5:(id)arg4 totalCount:(unsigned long long)arg5 sessionId:(id)arg6 isLocalSearch:(_Bool)arg7;
+ (void)ReportShowDescToEmoticon:(id)arg1 expId:(id)arg2 totalCount:(unsigned long long)arg3 sessionId:(id)arg4 wrapList:(id)arg5;
