...
+ (void)reportClickAvatar:(id)arg1 dadtaItem:(id)arg2 clickScene:(unsigned long long)arg3 feedScene:(unsigned long long)arg4 clickUsrContactType:(unsigned long long)arg5;
+ (void)reportChangeIdentity:(id)arg1 scene:(unsigned long long)arg2 currentCommentIdentityType:(unsigned long long)arg3;
+ (void)reportDataItemExpose:(id)arg1 exposeTimestamp:(double)arg2 exposeDuration:(double)arg3 scene:(unsigned long long)arg4;
+ (void)reportTimelineSeeMoreScene:(unsigned long long)arg1 action:(unsigned long long)arg2 isFloat:(_Bool)arg3;
...
+ (void)reportFinderRedDotWithType:(unsigned long long)arg1 action:(unsigned long long)arg2 lastVC:(id)arg3 subType:(long long)arg4 showType:(unsigned long long)arg5 redDotCount:(unsigned long long)arg6 redDotId:(id)arg7;
+ (void)reportFinderRedDotWithType:(unsigned long long)arg1 action:(unsigned long long)arg2 lastVC:(id)arg3 subType:(long long)arg4 showType:(unsigned long long)arg5 redDotCount:(unsigned long long)arg6;
+ (void)reportFinderRedDotWithType:(unsigned long long)arg1 action:(unsigned long long)arg2 lastVC:(id)arg3 subType:(long long)arg4 showType:(unsigned long long)arg5;
+ (void)reportFinderRedDotWithType:(unsigned long long)arg1 action:(unsigned long long)arg2 lastVC:(id)arg3 subType:(long long)arg4;
...
+ (void)reportShowFeedCommentListWithVCName:(id)arg1 feedID:(id)arg2 finderUsername:(id)arg3 currentLikeCount:(long long)arg4 friendLikeCount:(long long)arg5 commentCount:(long long)arg6 isClickAll:(_Bool)arg7 feedScene:(unsigned long long)arg8;
...
+ (void)reportPostScene:(int)arg1 PostState:(int)arg2 FeedID:(id)arg3 exitVCNumber:(int)arg4 videoSourceType:(int)arg5 postAssetsType:(int)arg6 assetsInfo:(id)arg7 hasAddText:(int)arg8 textLength:(int)arg9 hasAddPOI:(int)arg10 postExtLink:(id)arg11 postFromDraft:(int)arg12 tag:(id)arg13 editVideoParams:(id)arg14;
