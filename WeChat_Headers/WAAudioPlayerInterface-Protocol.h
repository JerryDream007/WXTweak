...
- (void)pause;
- (void)play;
- (void)setPlayerWithSrc:(NSString *)arg1 url:(NSURL *)arg2 startTime:(double)arg3 autoPlay:(_Bool)arg4 loop:(_Bool)arg5 obeyMuteSwitch:(_Bool)arg6 volume:(double)arg7 fileData:(NSData *)arg8 playbackRate:(double)arg9;
