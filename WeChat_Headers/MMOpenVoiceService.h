...
- (void)joinConferenceSync:(id)arg1 joinCallback:(CDUnknownBlockType)arg2 interruptedCallback:(CDUnknownBlockType)arg3 memberChangeCallback:(CDUnknownBlockType)arg4 videoMemberChangeCallback:(CDUnknownBlockType)arg5 speakerChangeCallback:(CDUnknownBlockType)arg6;
- (void)joinConference:(id)arg1 joinCallback:(CDUnknownBlockType)arg2 interruptedCallback:(CDUnknownBlockType)arg3 memberChangeCallback:(CDUnknownBlockType)arg4 videoMemberChangeCallback:(CDUnknownBlockType)arg5 speakerChangeCallback:(CDUnknownBlockType)arg6;
