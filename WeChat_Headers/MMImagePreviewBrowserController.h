...
@class EditImageIntialView, EditVideoLogicItem, MMAsset, MMAssetPickerSendButton, MMAssetSelectCheckButton, MMAssetSelectedCollectionView, MultiImageScrollView, NSMutableDictionary, NSString, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIView;
