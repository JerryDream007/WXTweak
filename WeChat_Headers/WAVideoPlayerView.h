...
@class MMUIButton, MMUIImageView, MMUILabel, NSString, NSURLConnection, TPVideoFrameBuffer, UIImage, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UITopTouchView, WAPlayerHttpMediaWrap, WAScreenBrightnessStateView, WAVideoLayer, WCNetworkMediaSlider, WCPlayerPlayArgs, WCPlayerView;
...
@interface WAVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, IVOIPUILogicMgrExt, WAStreamPlayerInterface>
{
    ...
    TPVideoFrameBuffer *_lastOutputFrameBuffer;
    struct CGSize _videoSize;
    struct CGRect _displayRect;
}

@property(retain, nonatomic) TPVideoFrameBuffer *lastOutputFrameBuffer; // @synthesize lastOutputFrameBuffer=_lastOutputFrameBuffer;
