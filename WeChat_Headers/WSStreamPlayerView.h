...
@class CAGradientLayer, HttpVideoStreamPlayerView, MMProgressViewEx, MMUIImageView, MMUILabel, MPVolumeView, NSMutableArray, NSString, UIButton, UIImageView, WAScreenBrightnessStateView, WCNetworkMediaSlider, WSPlayerMaskView, WSPlayerSimpleProgressBar, WSStreamDotAttachView, WSVideoModel, WSVideoOperateButton, WSVideoPlayStat, WSVideoSourceView;
@protocol WSVideoPlayerViewDelegate;

@interface WSStreamPlayerView : UIView <AVPlayerStateControlDelegate, UIGestureRecognizerDelegate, WSPlayerMaskViewDelegate, MMImageLoaderObserver, IVOIPUILogicMgrExt, WSStreamDotAttachViewDelegate>
{
