...
@interface WCPayLogicMgr : MMService <MMTipsViewControllerDelegate, ILinkEventExt, MMWebViewDelegate, MMResourceMgrExt, MMImageLoaderObserver, MMKernelExt, MMServiceProtocol, WCPayNetworkHelperDelegate, MMPackageDownloadMgrExt, IMsgExt, IAutoVerifySMSExt, INewABTestMgrExt>
{
