...
- (void)reportPatchUpdateKvInfo:(_Bool)arg1 debugMode:(unsigned long long)arg2 errCode:(unsigned long long)arg3 publicInfo:(id)arg4 isPatch:(_Bool)arg5 pkgSize:(unsigned int)arg6 filePath:(id)arg7 protocol:(unsigned long long)arg8;
- (void)reportKvInfo:(_Bool)arg1 debugMode:(_Bool)arg2 downloadPercent:(unsigned int)arg3 eventID:(unsigned int)arg4;
- (void)onDownloadTaskCompletion:(long long)arg1 taskUrl:(id)arg2 filePath:(id)arg3 protocol:(unsigned long long)arg4 totalLength:(unsigned long long)arg5;
