...
@interface MMWebViewController : MMUIViewController <MMWebSearchViewDelegate, MMWebMProfileTitleViewDelegate, MinimizationTransitionControllerDelegate, MMWebViewDelegate, MMScrollActionSheetDelegate, EnterpriseConnectorLogicDelegate, MMExposeViewControllerDelegate, H5GameScrollActionSheetDelegate, MMWebMenuHeaderViewDelegate, WCForceTouchPopProtocol, UIGestureRecognizerDelegate, IUiUtilExt, MMTipsViewControllerDelegate, ISysCallCheckExt, WCActionSheetDelegate, MMWebViewFontFloatViewDelegate, WebViewA8KeyLogicDelegate, WebViewJSLogicDelegate, UIScrollViewDelegate, MMJSApiVerifyMgrDelegate, ForwardMessageLogicDelegate, WCCommitViewResultDelegate, WebViewSanboxSessionLogicDelegate, WXCustomWebViewControllerProtocol, YYWebViewDelegate>
{
...
- (void)openFileDetailViewCtrlWithFileURL:(id)arg1 filePath:(id)arg2 fileName:(id)arg3 fileExtName:(id)arg4;
