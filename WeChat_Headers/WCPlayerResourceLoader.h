...
#import "TPAssetLoaderDelegate-Protocol.h"
...
@interface WCPlayerResourceLoader : NSObject <WCPlayerDownloaderDelegate, AVAssetResourceLoaderDelegate, TPAssetLoaderDelegate>
{
...
- (_Bool)resourceLoader:(id)arg1 NewLoadingRequestedResource:(id)arg2;
