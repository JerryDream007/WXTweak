...
@class EditImageAttr, EditImageIntialView, EditVideoAttr, EditVideoLogicItem, MMCircularProgressView, MMImageCropperViewController, MMLoadingView, MMShortVideoParamModel, MMSightRecordView, NSMutableArray, NSString, ShortVideoToolbarPreviewView, SightCameraPreviewView, SightCameraTopToolView, UIButton, UIImage, UIImageView, UILabel, UIView;
@protocol ShortVideoBarDelegate;

@interface ShortVideoToolbar : MMUIView <MonoServiceLogicExt, EditVideoLogicItemDelegate, MMImageCropperDelegate, WCEditVideoViewControllerDelegate, WCEditImageViewControllerDelegate, SightCameraCaptureExt, UITextFieldDelegate, EditImageInitialViewDelegate>
{
    _Bool m_isActive;
    double m_topPositon;
    ...
    _Bool _needsBeautyEffectForBackCamera;
    _Bool _needsBeautyEffectForFrontCamera;
    _Bool _isFirstSwitchCameraFromBackToFront;
    int _recordState;
    int _btnState;
...
@property(nonatomic) _Bool isFirstSwitchCameraFromBackToFront; // @synthesize isFirstSwitchCameraFromBackToFront=_isFirstSwitchCameraFromBackToFront;
@property(nonatomic) _Bool needsBeautyEffectForFrontCamera; // @synthesize needsBeautyEffectForFrontCamera=_needsBeautyEffectForFrontCamera;
@property(nonatomic) _Bool needsBeautyEffectForBackCamera; // @synthesize needsBeautyEffectForBackCamera=_needsBeautyEffectForBackCamera;
...
@property(retain, nonatomic) UIButton *m_beautyBtn; // @synthesize m_beautyBtn=_m_beautyBtn;
