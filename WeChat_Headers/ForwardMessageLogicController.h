...
@interface ForwardMessageLogicController : MMObject <SharePreConfirmViewDelegate, WCGroupUndoneEduViewDelegate, SessionSelectControllerDelegate, IMsgRevokeExt>
{
...
- (id)msgChangeForForward:(id)arg1;
