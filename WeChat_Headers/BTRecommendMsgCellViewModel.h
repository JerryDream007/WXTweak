...
@class BTRecommendAccountData, BTRecommendAppMsg, BTRecommendFeedbackInfo, BTRecommendSectionData, NSMutableArray, NSString, UIFont;
...
@property(nonatomic) __weak BTRecommendSectionData *sectionData;
