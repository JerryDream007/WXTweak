...
@class NSArray, NSString, UICollectionView, UIImageView, UILabel, UIPageControl;
...
{
    _Bool _selectEnable;
    _Bool _isIconHiddenAnimationTriger;
...
@property(nonatomic) _Bool isIconHiddenAnimationTriger; // @synthesize isIconHiddenAnimationTriger=_isIconHiddenAnimationTriger;
