...
@interface WXCTalkMgr : MMService <WXCCNetworkStatusExt, AUAudioDataSource, AVAudioPlayerDelegate, IAUAudioDeviceExt, MMKernelExt, MMServiceProtocol, WXCNetWorkDelegate>
{
...
- (_Bool)sendWXTalkSubscribeGeneralVideoRequest:(id)arg1 roomId:(unsigned int)arg2 roomKey:(unsigned long long)arg3 SelfMemberId:(int)arg4 SubscribeMemberList:(id)arg5;
...
- (void)StopSession;
- (void)RedirectTo:(id)arg1 withEngineConf:(id)arg2 withHeadSignArray:(id)arg3 withIsEncode:(_Bool)arg4 withTCPSvrArr:(id)arg5 withTCPStartTime:(int)arg6 withAudioEncryptType:(int)arg7 withAudioEncodeType:(int)arg8 withEncryptKey:(id)arg9 withGeneralPolicys:(id)arg10 withVideoEncryptType:(int)arg11;
- (void)SimpleRedirecTo:(id)arg1 withTCPSvrArr:(id)arg2;
- (void)StartSession:(id)arg1 withEngineConf:(id)arg2 withHeadSignArray:(id)arg3 withIsEncode:(_Bool)arg4 withTCPSvrArr:(id)arg5 withTCPStartTime:(int)arg6 withAudioEncryptType:(int)arg7 withAudioEncodeType:(int)arg8 withEncryptKey:(id)arg9 withGeneralPolicys:(id)arg10 withVideoEncryptType:(int)arg11;
