...
+ (void)reportOperationArrowBtnClickWithExpand:(_Bool)arg1 roomKey:(unsigned long long)arg2;
+ (void)reportOperationArrowBtnExposeWithExpand:(_Bool)arg1 roomKey:(unsigned long long)arg2;
