...
@class MMAlbum, MMAlbumDropPickerController, MMAsset, MMAssetPickerControllerProxyObject, MMAssetPickerControllerProxyObjectForAllAsset, MMAssetPickerSendButton, MMTableView, MMUIButton, MMUIImageView, MMUILabel, NSDateFormatter, NSMutableArray, NSMutableSet, NSString, UIButton, UIImageView, UIView;
