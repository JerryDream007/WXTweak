...
@class CContact, CEmoticonWrap, EmoticonBoardView, MMAdaptiveLabel, MMCPLabel, MMGrowTextView, MMHeadImageView, MMTableView, MMUILabel, MMURLHandler, NSMutableArray, NSMutableDictionary, NSObject, NSString, RichTextView, SharePreConfirmView, UIButton, UIImageView, UILabel, UIView, UrlLabel, WCADPageWrap, WCAdvertiseActionFloatView, WCCommentItem, WCCommentReport, WCCommentView, WCContentItem, WCContentItemBaseView, WCDataItem, WCHeaderGridView, WCInputController, WCOperateFloatView, WCPasteTextLengthLogic, WCSnsCommentDetailRewardView, WCTimelineCommentEmotionReport, WCUserComment;
@protocol WCCommentDetailViewControllerFBDelegate;

@interface WCCommentDetailViewControllerFB : MMUIViewController <InputControllerDelegate, BaseEmoticonViewDelegate, WCAdvertiseActionFloatViewDelegate, MMImageLoaderObserver, WCTimeLineContactSelectViewControllerDelegate, IMMGrowTextViewExt, WCTimeLineAdCardBaseViewDelegate, RichTextLayoutDelegate, IContactMgrExt, UITableViewDelegate, UITableViewDataSource, WCFacadeExt, IMsgExt, MMGrowTextViewDelegate, tableViewDelegate, WCActionSheetDelegate, ILinkEventExt, WCCommentViewDelegate, WCImageFullScreeViewMgrExt, IStrangerContactMgrExt, ITranslateSnsMgrExt, WCSightViewExt, IWCCommentDetailViewControllerFBExt>
{
