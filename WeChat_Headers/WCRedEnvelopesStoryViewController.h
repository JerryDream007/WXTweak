...
#import "WCRedEnvelopesStoryPageViewDelegate-Protocol.h"
...
@interface WCRedEnvelopesStoryViewController : MMUIViewController <UIScrollViewDelegate, UIGestureRecognizerDelegate, WCPayWebImageViewDelegate, WCRedEnvelopesStoryPageViewDelegate>
{
