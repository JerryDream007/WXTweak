...
@class CALayer, MMTimer, MMUIButton, MMUIImageView, MMUILabel, MMWebImageView, MMWebViewController, MPLandingVideoDotAdWebViewPosInfo, MPLandingVideoErrView, MPPlayerHttpMediaWrap, NSMutableArray, NSString, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UISlider, UITapGestureRecognizer, UITopTouchView, UIView, UIViewController, WAScreenBrightnessStateView, WCNetworkMediaSlider, WCPlayerPlayArgs, WCPlayerView;
...
@interface MPLandingVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, MPLandingVideoErrViewDelegate, MMWebImageViewDelegate>
{
    ...
    UIView *_oversizeTipsView;
    UILabel *_oversizeTipsLabel;
    CALayer *_oversizeTipsViewLayer;
...
@property(retain, nonatomic) CALayer *oversizeTipsViewLayer; // @synthesize oversizeTipsViewLayer=_oversizeTipsViewLayer;
@property(retain, nonatomic) UILabel *oversizeTipsLabel; // @synthesize oversizeTipsLabel=_oversizeTipsLabel;
@property(retain, nonatomic) UIView *oversizeTipsView; // @synthesize oversizeTipsView=_oversizeTipsView;
...
- (void)layoutOversizeViewIfNeed;
- (void)hideOversizeTips:(_Bool)arg1;
- (void)fadeOversizeTips;
- (void)showOversizeTips:(id)arg1;
