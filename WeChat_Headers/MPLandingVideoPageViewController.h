...
@interface MPLandingVideoPageViewController : MMUIViewController <MMScrollActionSheetDelegate, EnterpriseConnectorLogicDelegate, MMExposeViewControllerDelegate, ForwardMessageLogicDelegate, WCCommitViewResultDelegate, MMWebMenuHeaderViewDelegate, MPVideoPushAnimatedTransitioningDelegate, MPCustomInteractiveHandlerDelegate, MPLeftEdgeLeaveGestureHandlerDelegate, MPLandingPageTransitionCrontrollerDelegate, MPLandingPageMinimizeProtocol, MinimizationMaximizeTransitionDelegate, MPVideoDismissAnimatedTransitioninigDelegate, MPSystemPushAnimatedTransitioningDelegate, MPLandingVideoPlayerViewDelegate, UIScrollViewDelegate, MPLandingCommonSharePageLogicDelegate, WCActionSheetDelegate, CNetworkStatusExt, MMUIViewControllerExt, MMWebMProfileTitleViewDelegate>
{
