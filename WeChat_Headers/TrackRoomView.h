...
@class AnnotationLogicController, CAShapeLayer, HeadClusterView, MMLoadingView, MMTimer, NSString, NavigateLogicController, POIInfo, QMapView, TrackRoomTopBarView, UIButton, UIView;
@protocol TrackRoomViewDelegate;

@interface TrackRoomView : MMUIWindow <MMHeadImageAnnotationViewDelegate, ITrackRoomMgrExt, TrackRoomTopBarViewDelegate, QMapViewDelegate, WCActionSheetDelegate, ILocationMgrExt, IWXTalkieExt, IAUAudioDeviceExt, UIGestureRecognizerDelegate, NavigateLogicControllerDelegate>
{
