...
@class CMessageWrap, FTSWebSearchMgr, ForwardMessageLogicController, MMTableView, MMUILabel, MinimizationTransitionController, NSString, UITableViewCell, UITapGestureRecognizer, UIView, WCActionSheet, WCDataItem, WSCommentInputViewController, WSVideoFlowDataLogic, WSVideoFlowFeedBackViewController, WSVideoFlowMoreOpViewController, WSVideoModel, WSVideoWowEducateViewController;
...
@interface WSVideoFlowBaseViewController : MMUIViewController <WCActionSheetDelegate, WCCommitViewResultDelegate, ForwardMessageLogicDelegate, WSVideoFlowFeedBackDelegate, CNetworkStatusExt, CMobileSIMTypeExt, ITopStoryPluginMsgExt, WSCommentInputDelegate, WSVideoWowEducateDelegate, WSVideoFlowMoreOpDelegate, WSVideoFlowDataDelegate>
{
    ...
    WCActionSheet *_showingSheet;
}

+ (id)generateVideoFlowWithMinimizeData:(id)arg1 taskData:(id)arg2;
+ (id)GenerateVideoFlowWithVideoInfo:(id)arg1 webSearchMgr:(id)arg2 params:(id)arg3 returnBlock:(CDUnknownBlockType)arg4;
...
@property(nonatomic) __weak WCActionSheet *showingSheet; // @synthesize showingSheet=_showingSheet;
