...
@interface GetA8KeyLogic : MMObject <WCPayLogicMgrExt, IJumpEmoticonDetailCgiDelegate, ExtraDeviceLoginMgrExt, IScanBookMgrExt, WCNewCardDetailViewControllerDelegate, ContactSearchLogicDelegate, WCRedEnvelopesGetRedPacketPreviewCgiDelegate, WCFinderQRCodeViewModelDelegate, PBMessageObserverDelegate, IWCProductExt, WCProductDetailViewControllerDelegate, IWCDeviceBrandMgrExt, WCBaseControlMgrExt, MMUseCaseCallback>
{
