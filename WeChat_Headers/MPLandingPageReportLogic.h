...
- (void)reportShowOversizeTipsWithVideoSize:(unsigned int)arg1 wordingType:(unsigned int)arg2 currPlayedTimeMs:(unsigned long long)arg3 isFullScreen:(_Bool)arg4;
