...
@class CContact, MMTimer, MultiTalkBeforeTalkingOperateView, MultiTalkBottomOperatePanel, MultiTalkContactsCollectionView, MultitalkSecondOperateView, NSArray, NSDictionary, NSString, UIImageView, WCUIAlertView, WXCGroupMember, WXCMultiTalkGroup;
@protocol MultiTalkMainViewControllerDelegate;

@interface MultiTalkMainViewController : MMUIViewController <MultiTalkMgrExt, MMNewMultiSelectContactsViewControllerDelegate, MultiTalkContactsCollectionViewDelegate, UIViewControllerTransitioningDelegate, MultiTalkBeforeTalkingOperateViewDelegate, MultiTalkBottomOperatePanelDelegate, MultitalkSecondOperateViewDelegate, IRecordPermissionCheckExt, MMTipsViewControllerDelegate, MultiTalkMainWindowDelegate>
{
    _Bool _m_isCaller;
...
- (void)onMultiTalkBottomOperatePanelMuteOff;
- (void)onMultiTalkBottomOperatePanelMuteOn;
