...
@class NSIndexPath, NSString, UIButton, UILabel, UIView, WCFinderComment, WCFinderFeedContentTextView, WCFinderHeadImageView;
@protocol WCFinderFeedDetailCommentCellActionDelegate;

@interface WCFinderFeedSubCommentTableViewCell : UITableViewCell <WCFinderFeedContentTextClickActionDelegate, WCFinderHeadImageViewDelegate>
{
...
- (void)updateWithComment:(id)arg1 enableShowFinder:(_Bool)arg2;
- (void)layoutSubviews;
