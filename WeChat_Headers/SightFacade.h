...
@interface SightFacade : MMService <MMServiceProtocol, IMsgExt, SightCaptureDelegate, MMovieCompressorDelegate>
{
...
- (void)adaptiveBitrateAdjustment:(id)arg1 VideoTrack:(id)arg2 Asset:(id)arg3 scene:(unsigned long long)arg4 VideoEncodeParams:(id)arg5 videosize:(struct CGSize)arg6 Edited:(_Bool)arg7 enableABA:(_Bool)arg8;
...
- (unsigned long long)beautyMultiSamplingValue;
...
- (_Bool)getEnableHEVCEncodeFinder;
