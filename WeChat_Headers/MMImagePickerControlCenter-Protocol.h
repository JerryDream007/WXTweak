...
@class MMAsset, MMImagePickerReportInfo, NSArray, NSDictionary, NSString, SightDraft, WCFinderDataItem, WCFinderReportPostStateModel;
...
- (void)selectedDataItem:(WCFinderDataItem *)arg1 GPSInfoArrayOfAsset:(NSArray *)arg2 dataReportModel:(WCFinderReportPostStateModel *)arg3;
