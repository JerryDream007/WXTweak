...
@class CLLocation, LocationRetriever, MMAutoSearchLogic, MMLocationAttributeBanner, MMLocationPinView, MMPickLocationSearchView, NSMutableArray, NSString, POIItem, PickLocationManager, QMapView, UIBarButtonItem, UIButton, UIImageView, UIPinchGestureRecognizer, UIView;
