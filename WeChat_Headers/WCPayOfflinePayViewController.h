...
@property(nonatomic) _Bool bIsViewIsAppear; // @synthesize bIsViewIsAppear=_bIsViewIsAppear;
...
- (void)onSelectPayCardViewClickForbidTinyAppUsername:(id)arg1 appPath:(id)arg2;
