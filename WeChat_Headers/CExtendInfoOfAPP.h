...
@class AppInnerJumpItem, AppMMScheduleItem, AppMsgShareItem, AppProductItem, AppTVItem, BrandMpVideoItem, CMessageWrap, CardTicketItem, EmoticonAppMsgItem, EmoticonSharedItem, EmotionDesignerSharedItem, EmotionPageSharedItem, FavoritesItem, GiftCardItem, HardWareItem, MMTemplateMsg3rdAppShowItem, MallProductItem, MessageExpItem, NSArray, NSMutableDictionary, NSString, OpenSDKAppBrandItem, ScanCodeHistoryItem, WAAppMsgItem, WCCanvasPageItem, WCFinderMessageShareItem, WCFinderMessageShareNameCard, WCFinderMessageVerifyItem, WCFinderShareToMomentsItem, WCFinderTopicShareItem, WCPayExtensionInfo, WCPayInfoItem, WCPayThirdInfo, WSVideoModel, iWatchAppMsgItem;
...
@interface CExtendInfoOfAPP : NSObject <IMessageWrapExt, IMsgExtendOperation, NSCopying>
{
    ...
    WCFinderMessageShareItem *m_finderShareItem;
