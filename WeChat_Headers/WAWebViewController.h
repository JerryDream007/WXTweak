...
@class FixDocumentPresent, MMProgressViewEx, MMScrollActionSheet, MMUIButton, NSDictionary, NSMutableDictionary, NSString, NSTimer, NSURLRequest, UIImageView, UILongPressGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView, WAAppActionSheet, WABaseInfoToast, WACacheVersionChecker, WAEvaluatePopSheet, WAMenuPopInteractiveTransition, WANavLoadingLayer, WAWebErrorView, WAWebViewJSLogicImpl, WAWebViewMenuNavBarProperties, WAWebViewMutiFuncMenuView, WAWebViewPluginScheduler, WAWebviewBottomBannerView;
...
- (void)onCopyPathAndQuerySuccess:(id)arg1;
- (void)onCopyPathAndQueryOrigin;
