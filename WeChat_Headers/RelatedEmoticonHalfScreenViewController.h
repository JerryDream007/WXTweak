...
@class CADisplayLink, CEmoticonWrap, EmoticonPreviewWindowViewController, EmoticonRecommendBoardCgi, NSArray, NSIndexPath, NSString, RelatedEmoticonReportObject, UICollectionView, UICollectionViewFlowLayout, UILongPressGestureRecognizer, WSSImilarPageModel;
@protocol RelatedEmoticonHalfScreenViewControllerDelegate;

@interface RelatedEmoticonHalfScreenViewController : MMUIHalfScreenViewController <MMTipsViewControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, RelatedEmoticonCollectionFooterViewDelegate, EmoticonRecommendBoardCgiDelegate, EmoticonPreviewWindowViewControllerDelegate>
{
