...
@class MMWebViewController, MMWebViewMpInfoModel, MPLandingVideoDotAdWebViewPosInfo, NSDictionary, NSMutableArray, NSNumber, NSString, UIColor;
...
@optional
- (void)setTopBarState:(_Bool)arg1 mpInfoModel:(MMWebViewMpInfoModel *)arg2;
