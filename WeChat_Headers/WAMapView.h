...
@property(retain, nonatomic) NSMutableArray *markerArray; // @synthesize markerArray=_markerArray;
...
- (_Bool)isMarkerExist:(long long)arg1;
- (void)enqueueMarker:(long long)arg1;
