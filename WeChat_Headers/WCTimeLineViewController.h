...
@class CContact, CEmoticonWrap, EmoticonBoardView, MMGrowTextView, MMHeadImageView, MMTableView, MMTipsViewController, MMUIButton, MMUIImageView, MMUILabel, MMURLHandler, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSNumber, NSString, SharePreConfirmView, UIButton, UIImageView, UITableViewCell, UIView, WCADPageWrap, WCAdvertiseActionFloatView, WCCommentEmotionFloatView, WCCommentReport, WCDataItem, WCInputController, WCListHeaderView, WCOperateFloatView, WCPasteTextLengthLogic, WCPlainTextTipFullScreenView, WCStoryEntranceVM, WCStoryReportUtil, WCStoryTimelineEntranceTableViewCell, WCTimeLineFooterView, WCTimeLineHeaderView, WCTimeLineVideoPreloadMgr, WCTimelineJumpToMissReadBtn, WCUserComment, WeishiReportItem;
...
@interface WCTimeLineViewController : MMUIViewController <tableViewDelegate, BaseEmoticonViewDelegate, WCSnsABTestMgrExt, WCCommitViewAnimationDelegate, ITranslateSnsMgrExt, INewMsgNotifyExt, MMExposeViewControllerDelegate, MMSightCameraViewControllerDelegate, WCAdvertiseActionFloatViewDelegate, MMNavBarInteractiveDelegate, IMMGrowTextViewExt, WCChatRoomStoryDataVMExt, IWCStoryEntranceVMExt, WCStoryFriendsCollectionViewControllerDelegate, WCStoryTimelineEntranceTableViewCellDelegate, UITableViewDelegate, UITableViewDataSource, WCActionSheetDelegate, WCFacadeExt, WCTimeLineCellViewDelegate, EGORefreshTableHeaderDelegate, MMRefreshTableFooterDelegate, InputControllerDelegate, scrollViewDelegate, UIGestureRecognizerDelegate, WCListHeaderViewDelegate, MMTipsViewControllerDelegate, WCCommentStrangerViewControllerDelegate, WCCommentDetailViewControllerFBDelegate, WCTimeLineCommentCellViewDelegate, ILinkEventExt, WCSetPermissionsViewControllerDelegate, IMMFacebookMgrExt, MMImagePickerManagerDelegate, WCPlainTextTipFullScreenViewDelegate, WCSightViewExt, WCContentItemViewExt, WCImageFullScreeViewMgrExt, WCTimelineCellABTestTipExt, WCTimeLineContactSelectViewControllerDelegate>
{
    ...
    WCTimelineJumpToMissReadBtn *_missReadBtn;
    UITableViewCell *_missReadBtnCell;
}
...
@property(nonatomic) __weak UITableViewCell *missReadBtnCell; // @synthesize missReadBtnCell=_missReadBtnCell;
@property(retain, nonatomic) WCTimelineJumpToMissReadBtn *missReadBtn; // @synthesize missReadBtn=_missReadBtn;
...
- (void)tryUpdateMissReadBtn;
- (void)onPrePageUpdate:(_Bool)arg1;
- (void)setIsJumpState:(_Bool)arg1;
...
- (void)showDetailViewForDataItem:(id)arg1 tipType:(unsigned long long)arg2;
