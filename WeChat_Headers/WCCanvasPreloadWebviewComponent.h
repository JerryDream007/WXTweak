...
@interface WCCanvasPreloadWebviewComponent : WCCanvasComponent <YYWebViewDelegate, WCCanvasJSLogicDelegate, MMImageLoaderObserver>
{
...
- (_Bool)onAdH5FuncDispatched:(id)arg1;
- (void)onOperateOpenUrlInWebview:(id)arg1;
