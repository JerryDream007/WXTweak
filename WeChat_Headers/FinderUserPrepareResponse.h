...
@property(nonatomic) _Bool isNonresidentFinderacctLocation; // @dynamic isNonresidentFinderacctLocation;
@property(nonatomic) _Bool isNonresidentRealtimeLocation; // @dynamic isNonresidentRealtimeLocation;
@property(nonatomic) _Bool isNonresidentWxacctLocation; // @dynamic isNonresidentWxacctLocation;
