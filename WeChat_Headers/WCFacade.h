...
@interface WCFacade : MMService <IContactMgrExt, MMConfigMgrExt, INewABTestMgrExt, PBMessageObserverDelegate, IExptServiceExt, WCTimelineDelegate, MMServiceProtocol, WCBGImgLogicNotity, WCDownloadMgrDelegate, WCCommentUploadMgrDelegate, WCUploadMgrDelegate, WCNotificationCenterMgrDelegate, WCHomepageDelegate, WCLogicMgrDelegate, WCFacadeExt, WCBGRecommendMgrDelegate, WCGroupMgrExt, WCAdvertiseCommentUploadMgrDelegate, IMMFontMgrExt, WCPreloadLogicDelegate, IMsgExt, WCCdnDownloadImageDelegate, WCPlayerDownloadMgrInterface>
{
    MyWCDB *m_database;
...
- (void)stopPreloadSNSVideoWithMediaItem:(id)arg1 Result:(struct C2CDownloadResult *)arg2;
...
- (void)onUpdateDataItemDetailFinished:(int)arg1 itemId:(id)arg2 dataItem:(id)arg3;
...
- (_Bool)updateTimelineHead:(_Bool)arg1;
