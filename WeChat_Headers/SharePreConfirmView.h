...
@class BaseMsgContentLogicController, ChatroomProfileView, DotLoadingView, EmoticonBoardView, MMGrowTextView, MMUIButton, NSArray, NSString, NamePreLabel, UIButton, UIImage, UIImageView, UILabel, UISwitch, UIView, UIViewController, WCGroupUndoneShareReport, WCInputController, WCPasteTextLengthLogic;
@protocol SharePreConfirmViewDelegate;

@interface SharePreConfirmView : MMUIWindow <IUiUtilExt, MMKernelExt, WCGroupUndoneEduViewDelegate, MMGrowTextViewDelegate, IMsgExt, InputControllerDelegate, IMMGrowTextViewExt>
{
