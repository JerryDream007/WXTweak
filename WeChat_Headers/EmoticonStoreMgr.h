...
@class EmoticonStoreMainTabExptSetting, EmoticonStoreSecondTabExptSetting, EmoticonStoreSession, NSData, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString;

@interface EmoticonStoreMgr : MMService <StoreEmotionExchangeEmotionPackCgiDelegate, MMServiceProtocol, PBMessageObserverDelegate, IAPExt, ICdnComMgrExt, IMMLanguageMgrExt>
{
...
- (void)OnGetStoreEmoticonItemDetailFailed:(id)arg1;
