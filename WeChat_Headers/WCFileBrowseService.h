...
@interface WCFileBrowseService : MMService <IMsgExt, IFavoritesExt, IFileDetailExt, WXGImportMessageNotification, MMServiceProtocol>
{
    _Bool _bOpen;
...
- (void).cxx_destruct;
- (unsigned int)getFirstScreenCount:(unsigned long long)arg1 withBrowseInfoArray:(id)arg2;
