...
@interface TXLivePush : NSObject <TXINotifyDelegate, TXICustomPreprocessDelegate, TXICaptureAndEncDelegate, TXIUploaderDelegate, TXIQoSDelegate, TXBeautyManagerTraitControl>
{
    int _videoQuality;
    NSString *_rtmpURL;
