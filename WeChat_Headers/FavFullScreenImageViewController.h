...
@class EditImageForwardAndEditLogicController, MMFullScreenItemView, MMScrollView, NSMutableArray, NSString, ScanQRCodeLogicController, SimpleImgInfo, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
@protocol FavFullScreenImageViewControllerDelegate;

@interface FavFullScreenImageViewController : FullScreenViewController <FavForwardLogicDelegate, EditImageForwardAndEditLogicDelegate, WCImageTranslateDelegate, UIScrollViewDelegate, scrollViewDelegate, FavImageFullScreenViewContainerDelegate, WCActionSheetDelegate, BaseScanLogicDelegate>
{
