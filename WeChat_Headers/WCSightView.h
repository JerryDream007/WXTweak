...
@interface WCSightView : MMUIControl <SightViewDelegate, WCNetworkMediaPlayerDelegate, IUiUtilExt, WCCanvasPageViewControllerDelegate, WCPlayerDownloaderExt, WCCanvasPageViewControllerExt, WCSNSADPlayerControlViewDelegate, WCAdFullScreenVideoViewControllerDelegate, WCFacadeExt, UIActionSheetDelegate, WCSightFullPlayViewControllerDelegate>
{
