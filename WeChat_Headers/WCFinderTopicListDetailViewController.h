...
@class ForwardMessageLogicController, NSIndexPath, NSMutableDictionary, NSString, UIImageView, UILabel, UITableView, UITapGestureRecognizer, WCFinderAnimationLoadingView, WCFinderCommentDatailViewController, WCFinderFeedContentVM, WCFinderRefreshTableFooterView, WCFinderTopicListDetailViewModel;

@interface WCFinderTopicListDetailViewController : MMUIViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, MMRefreshTableFooterDelegate, WCFinderRefreshTableFooterViewDelegate, ForwardMessageLogicDelegate, WCCommitViewResultDelegate, WCFinderMulitMediaTableViewCellDelegate, WCFinderContentTableViewCellDelegate, WCFinderToolbarTableViewCellDelegate, WCFinderFeedCommentTableViewCellDelegate, MMScrollActionSheetDelegate, WCFinderTopicListDetailViewModelDelegate, WCGeneralListMonitorExt, WCFinderVideoPlayerExt, WCFinderCommentDatailViewControllerDelegate, WCFinderCommentIdentityViewControllerDelegate>
{
