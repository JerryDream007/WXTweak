...
- (void)createRequest;
- (id)initWithPosterUsername:(id)arg1 finderUsername:(id)arg2 refObjectID:(id)arg3 reportScene:(unsigned long long)arg4 optype:(unsigned long long)arg5 successBlock:(CDUnknownBlockType)arg6 failureBlock:(CDUnknownBlockType)arg7;
