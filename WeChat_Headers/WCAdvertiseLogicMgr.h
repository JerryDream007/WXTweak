...
@interface WCAdvertiseLogicMgr : MMObject <PBMessageObserverDelegate>
{
    ...
    NSMutableDictionary *adSubscriptionLogicCache;
}
...
- (id)getAdSubscriptionLogic:(id)arg1;
- (void)deleteSubscriptionLogic:(id)arg1;
- (void)addAdSubscriptionLogic:(id)arg1 withSnsId:(id)arg2;
