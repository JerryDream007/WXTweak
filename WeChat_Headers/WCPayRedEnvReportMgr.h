...
- (void)genRedEnvStoryViewVideo:(id)arg1 videoUrl:(id)arg2 replayCount:(unsigned int)arg3 playTime:(unsigned int)arg4 sessionId:(id)arg5;
- (void)genRedEnvStoryViewPic:(id)arg1 picUrl:(id)arg2 sessionId:(id)arg3;
