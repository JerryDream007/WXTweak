...
@interface WCFinderFeedVM : NSObject <WCFinderDataItemExt, WCFinderPostingCommentExt, WCFinderRedDotNotifyExt, WCFinderPostDataItemExt, WCFinderStreamPreFetchExt>
{
...
- (void).cxx_destruct;
- (void)onFinderStreamPreFetchRefetchFinished:(_Bool)arg1 isOverWriteData:(_Bool)arg2;
- (void)onFinderStreamPreFetchSuccess;
