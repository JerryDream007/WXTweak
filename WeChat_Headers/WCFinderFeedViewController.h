...
- (id)getItemArrayConfig:(_Bool)arg1;
...
- (void)refreshHeaderBackAnimation:(CDUnknownBlockType)arg1;
- (void)onFeedVMCommentFailNeedReload;
- (void)onFeedVMDataItemMediaResourceIsDeleted;
- (void)onFeedVMPrefetchSuccess;
- (void)onFeedVMDataPreFetchFailed;
- (void)onFeedVMDataPreFetchSuccess;
- (void)onFeedLastestVideoMuteNeedChange;
- (void)onFeedVMDataPreFetchAnimationStop:(CDUnknownBlockType)arg1;
...
- (void)setCameraRedPointHidden:(_Bool)arg1;
