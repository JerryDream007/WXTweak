...
#import "_TtP12MMFoundation19KaraPredictionEvent_-Protocol.h"

@class CMessageWrap, ImageAutoControl, NSMutableArray, NSString;

@interface ImageAutoDownloadMgr : MMService <_TtP12MMFoundation19KaraPredictionEvent_, MMServiceProtocol, IMsgExt, IDownloadImageExt, IEnterpriseMsgExt>
{
...
- (void).cxx_destruct;
- (void)queueInBackgroundForMsg:(id)arg1;
...
- (void)dealloc;
- (id)init;
- (void)onPredicted:(id)arg1;
@property(nonatomic, readonly) long long solution;
