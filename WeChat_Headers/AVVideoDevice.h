...
- (int)getCaptureFps;
- (void)willOutputCVPixelBuffer:(struct __CVBuffer *)arg1 IsBeautySupport:(_Bool)arg2 IsSTDenoisingSupport:(_Bool)arg3;
- (void)willOutputSamplesBuffer:(struct opaqueCMSampleBuffer *)arg1;
- (void)newVideoRawSampleToGPUImage:(struct opaqueCMSampleBuffer *)arg1 IsBeautySupport:(_Bool)arg2 IsSTDenoisingSupport:(_Bool)arg3;
