...
+ (id)displayName:(id)arg1 nickname:(id)arg2 isAdvertiserUser:(_Bool)arg3 commentInfo:(id)arg4;
+ (id)genContentUserAttributeStr:(id)arg1 nickname:(id)arg2 isHBComment:(_Bool)arg3 isAdvertiserUser:(_Bool)arg4 commentInfo:(id)arg5;
