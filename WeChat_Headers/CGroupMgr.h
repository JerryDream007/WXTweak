...
@class CGroupDB, CGroupOpLog, ChatRoomPanelDynamicWeAppCache, ChatRoomToolMgr, NSMutableArray, NSString;

@interface CGroupMgr : MMService <IContactMgrExt, MMServiceProtocol, NotifyFromEventDelegate, PBMessageObserverDelegate, IMsgExt>
{
    CGroupDB *m_oGroupDB;
...
- (_Bool)UpgradeAssociateChatRoom:(id)arg1;
