...
@class FavBaseSearchConfig, FavBaseTableDataController, FavClickStreamData, FavMultiSelectToolView, MMFavoritesSearchController, MMTableView, NSString, UILabel, UIView;
@protocol FavBaseSearchViewControllerDelegate;

@interface FavBaseSearchViewController : MMUIViewController <FavSearchControllerDelegate, IFavoritesExt, FavForwardLogicDelegate, FavBaseTableDataControllerDelegate, WCActionSheetDelegate, MMTipsViewControllerDelegate>
{
