...
#import "IWAWebViewPlugin_LivePlayer-Protocol.h"
...
- (void)snapshotLivePlayer:(unsigned int)arg1 needCompress:(_Bool)arg2 finish:(CDUnknownBlockType)arg3;
