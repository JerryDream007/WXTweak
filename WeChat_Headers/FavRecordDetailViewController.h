...
@interface FavRecordDetailViewController : FavBaseDetailViewController <BaseScanLogicDelegate, IFavCdnDownloadMgrExt, WCActionSheetDelegate, scrollViewDelegate, FavRecordNodeViewDelegate, ViewLocationDelegate, FavForwardLogicDelegate>
{
