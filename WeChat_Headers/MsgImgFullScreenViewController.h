...
@class BrandMpVideoReporter, CAGradientLayer, CMessageWrap, EditImageForwardAndEditLogicController, ForwardMessageLogicController, ImageScrollView, MMProgressViewEx, MMTimer, MMToastViewController, MMUIButton, MessageInterceptReporter, MsgImgDataLogic, MsgImgFullScreenContainer, MsgImgPreviewData, NSArray, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString, ScanQRCodeLogicController, ShareDataToOpenSDKController, SightIconView, UIActivityIndicatorView, UILabel, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic;
@protocol MsgImgFullScreenViewControllerDelegate;

@interface MsgImgFullScreenViewController : MMUIViewController <BaseScanLogicDelegate, WXVideoPlayerViewDelegate, WXVideoPlayerViewTouchDelegate, MsgImgDataLogicDelegate, UIViewControllerAnimatedTransitioning, MMToastViewControllerDelegate, ForwardMessageLogicDelegate, EditImageForwardAndEditLogicDelegate, UIViewControllerTransitioningDelegate, WCImageTranslateDelegate, WCActionSheetDelegate, MsgImgFullScreenContainerDelegate, IDownloadImageExt, IMsgExt, IMsgRevokeExt>
{
    ...
    MMUIButton *_hdImgBtn;
    MMUIButton *_hdImgStatusButton;
    MMUIButton *_btnForImgFastBrowse;
    MMUIButton *_btnForDownloadImage;
    MMUIButton *_moreBtn;
    ...
    CMessageWrap *_referedMessageWrap;
...
@property(retain, nonatomic) CMessageWrap *referedMessageWrap; // @synthesize referedMessageWrap=_referedMessageWrap;
...
- (id)initWithMsgWrap:(id)arg1 originFrame:(struct CGRect)arg2 soundable:(_Bool)arg3 snapshotView:(id)arg4 needEdit:(_Bool)arg5 isShowSingleMsg:(_Bool)arg6 eScene:(unsigned long long)arg7;
...
- (void)reportBrandMpVideoOpType:(unsigned long long)arg1;
