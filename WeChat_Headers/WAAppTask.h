...
@interface WAAppTask : NSObject <WAMenuAnimatedTransitionProtocol, WASplashADViewControllerDelegate, WCMainWindowExt, WAAppTansitionControllerDelegate, WAJavaScriptContextExtension, WAAppDetailInfoManagerExtension, WAAppTaskLoaderDelegate, WAWebViewDelegate, WAMinimizeDelegate, WAJSCoreServiceDelegate, WAPermissionHandlerDelegate, MMTipsViewControllerDelegate, WAContactMgrExtension, WABackgroundFetchExt>
{
