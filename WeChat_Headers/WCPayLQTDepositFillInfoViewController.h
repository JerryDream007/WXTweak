...
#import "WCPayRecommendItemViewDelegate-Protocol.h"

@class NSString, RichTextView, UIButton, UILabel, UITextField, UIView, WCBaseKeyboardToolBar, WCPayDecimalKeyboardView, WCPayLQTSelectCardItem, WCPayLQTSelectDateItem, WCPayRecommendItemView;
@protocol WCPayLQTDepositFillInfoViewControllerDelegate;

@interface WCPayLQTDepositFillInfoViewController : WCPayBaseViewController <WCBaseInfoItemDelegate, WCPayRecommendItemViewDelegate, WCPayDecimalKeyboardViewDelegate, ILinkEventExt, WCPayLQTSelectCardItemDelegate, UITextFieldDelegate, WCPayLQTSelectDateItemDelegate>
{
