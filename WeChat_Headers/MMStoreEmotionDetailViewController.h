...
@property(retain, nonatomic) UIButton *m_uninstallButton; // @synthesize m_uninstallButton;
...
- (void)makeUninstallButton:(id)arg1 item:(id)arg2;
...
- (struct CGPoint)updateUninstallButton:(struct CGPoint)arg1;
