...
@class NSArray, NSDictionary, NSMutableArray, NSString, UIViewController, WACacheVersionPreCheckerContextResult, WAContact, WAPackageConfig, WAWebViewController;
...
- (void)setupAppServiceAndWebViewWithAppID:(NSString *)arg1 contact:(WAContact *)arg2 packageConfig:(WAPackageConfig *)arg3 baseURL:(NSString *)arg4 pageRelativeURL:(NSString *)arg5 getWebView:(id *)arg6 shouldUseComponentLazyLoad:(_Bool)arg7;
