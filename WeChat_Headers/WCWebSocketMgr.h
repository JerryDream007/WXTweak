...
- (long long)connectWebSocket:(unsigned int *)arg1 group:(id)arg2 appType:(unsigned int)arg3 appDebugModeType:(unsigned int)arg4 url:(id)arg5 httpHeaders:(id)arg6 subProtocols:(id)arg7 tlsSkipHostnameCHeck:(_Bool)arg8 pongTimeout:(unsigned int)arg9 handshakeTimeout:(unsigned int)arg10 tcpNoDelay:(_Bool)arg11 perMessageDeflate:(_Bool)arg12 userAgent:(id)arg13 referer:(id)arg14;
- (void)onServiceInit;
