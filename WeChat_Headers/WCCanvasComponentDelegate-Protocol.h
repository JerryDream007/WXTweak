...
@class MMUIViewController, NSArray, NSDictionary, NSNumber, NSString, POIInfo, UIColor, UIImage, UIView, UIViewController, WCAdvertiseInfo, WCCanvasComponent, WCCanvasComponentItem, WCCanvasReportMgr, WCWeAppBizTempSessionInfo;
...
@optional
- (void)onPureImageLongPress:(_Bool)arg1 image:(UIImage *)arg2 url:(NSString *)arg3 type:(unsigned int)arg4;
