...
@class CBaseContact, CContact, CEmoticonWrap, CMessageWrap, LinkWeAppJumpWrap, MMUIViewController, NSArray, NSMutableArray, NSString, PushMailWrap, TranslateInfo;
...
- (void)shouldShowRelativeEmoticonViewControllerWithEmoticonWrap:(CEmoticonWrap *)arg1;
