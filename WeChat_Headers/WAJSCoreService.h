...
#import "wxNativeReportDelegate-Protocol.h"
...
@property(nonatomic) unsigned int weAppWorkerId; // @synthesize weAppWorkerId=_weAppWorkerId;
...
- (void)reportScriptInjectTime:(id)arg1 length:(long long)arg2 startTime:(unsigned long long)arg3 endTime:(unsigned long long)arg4 preload:(unsigned int)arg5;
...
- (void)injectJSBaseForAppBrandThread:(id)arg1 sdkScript:(id)arg2 privateNativeScriptBeforeUserScript:(id)arg3 userScriptFile:(id)arg4 fromPreload:(_Bool)arg5;
- (id)getNetType;
