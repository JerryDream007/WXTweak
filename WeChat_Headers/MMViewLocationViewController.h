...
@class AnnotationLogicController, FavDataItemWrap, FavoritesItem, MMTimer, MMUILabel, MMUIView, NSArray, NSString, NSURL, NavigateLogicController, POIInfo, QMapView, UIButton, UnderLineLabel;
@protocol ViewLocationDelegate;

@interface MMViewLocationViewController : MMUIViewController <QMapViewDelegate, WCActionSheetDelegate, ILocationMgrExt, NavigateLogicControllerDelegate, IScanStreetViewMgrExt, IFavoritesExt, FavTagViewDelegate>
{
    _Bool _canAddToFav;
