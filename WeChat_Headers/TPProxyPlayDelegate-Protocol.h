...
@protocol TPProxyPlayDelegate <NSObject>
...
- (id)onPlayCallbackWithMessageType:(unsigned long long)arg1 ext1:(NSObject *)arg2 ext2:(NSObject *)arg3 ext3:(NSObject *)arg4 ext4:(NSObject *)arg5;
