...
@class ForwardMessageLogicController, NSIndexPath, NSMutableDictionary, NSString, UILabel, UITableView, UITapGestureRecognizer, UIView, WCFinderCommentDatailViewController, WCFinderCreateCoordinator, WCFinderFeedContentVM, WCFinderLikeListViewModel, WCFinderRefreshTableFooterView;
