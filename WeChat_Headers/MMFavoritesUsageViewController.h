...
@interface MMFavoritesUsageViewController : MMUIViewController <FavBaseTableDataControllerDelegate, IFavoritesExt, WCActionSheetDelegate>
{
...
- (void).cxx_destruct;
- (void)OnGetNextPageFavoritesCapacityItemList:(id)arg1 IsSuccess:(_Bool)arg2 HasMoreItems:(_Bool)arg3;
- (void)OnGetFirstPageFavoritesCapacityItemList:(id)arg1 IsSuccess:(_Bool)arg2 HasMoreItems:(_Bool)arg3;
