...
@interface GetTestCodeDownloadInfoRequest : WXPBGeneratedMessage
{
}
...
@property(nonatomic) int codeType; // @dynamic codeType;
@property(nonatomic) unsigned int devKey; // @dynamic devKey;
@property(retain, nonatomic) NSString *moduleMd5; // @dynamic moduleMd5;
