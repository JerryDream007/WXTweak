...
@interface MultiSelectController : MMObject <MMToastViewControllerDelegate, WCActionSheetDelegate, EnterpriseSessionSelectViewControllerDelegate, EnterpriseBrandContactSelectViewControllerDelegate, MsgDataSaveLogicDelegate, WebMailViewDelegate, ForwardMessageLogicDelegate, MFMailComposeViewControllerDelegate>
{
