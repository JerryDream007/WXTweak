...
@class MMUIButton, MMUIView, NSString, RichTextView, WCAdSubscriptionLogic, WCAdVoteLineView, WCDataItem, WCHighLightButton, WCSightView, WCTimeLineTagView;
@protocol WCTimeLineAdCardBaseViewDelegate;

@interface WCTimeLineAdCardBaseView : WCContentItemBaseView <WCAdSubscriptionLogicDelegate>
{
    int _mediaType;
