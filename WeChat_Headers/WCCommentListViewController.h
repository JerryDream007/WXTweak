...
@class MMTableView, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, UIView, WCCommentEmotionFloatView, WCSNSMessage, WCStatTimerHelper, WCTimeLineFooterView;

@interface WCCommentListViewController : MMUIViewController <WCCommentListContentViewDelegate, IContactMgrExt, UITableViewDataSource, UITableViewDelegate, tableViewDelegate, IMsgExt, WCFacadeExt, WCActionSheetDelegate, MMRefreshTableFooterDelegate, WCCommentDetailViewControllerFBDelegate, WCImageFullScreeViewMgrExt>
{
