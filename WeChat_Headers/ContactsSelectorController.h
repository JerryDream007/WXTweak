...
@class NSMutableArray, NSMutableDictionary, NSString, UINavigationController, WCSelectorView;
@protocol ContactsSelectorControllerDelegate, SelectorControllerDelegate;

@interface ContactsSelectorController : MMObject <MultiSelectContactsViewControllerDelegate, WCSelectorViewDelegate, WCSelectorViewDataSource, WCContactItemDeleteViewDelegate>
{
