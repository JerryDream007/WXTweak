...
@class NSLock, NSMutableArray, NSObject, NSString, NSThread, TXBeautyManager, TXCCameraCapturer, TXCLiveMixPlayer, TXCRenderView, TXCVideoEncoder, TXCVideoPreprocessorEx, TXReplayKitMixer, TXSNALPacket, UIImage;
