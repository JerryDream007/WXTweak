...
@interface MMUIViewController : UIViewController <IUiUtilExt, MMUIViewControllerDelegate, UIGestureRecognizerDelegate>
{
    ...
    NSMutableDictionary *m_extendOperationStorage;
    _Bool _m_bAnimating;
...
- (void)callAllExtendOperation:(id)arg1;
- (void)extendOperation:(id)arg1 withTag:(id)arg2 andBlock:(CDUnknownBlockType)arg3;
- (_Bool)isPresentedIn;
- (_Bool)isPushedIn;
