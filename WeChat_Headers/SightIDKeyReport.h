...
+ (void)reportConcreteABAPrams:(unsigned long long)arg1 videosize:(struct CGSize)arg2 inputKbps:(int)arg3 fps:(int)arg4 streamType:(int)arg5 abaReportPrams:(id)arg6 VideoEncodeParams:(id)arg7 consumingTime:(long long)arg8 oriTargetBitrate:(float)arg9 enableHEVCEncode:(_Bool)arg10 enableABA:(_Bool)arg11;
