...
- (void)reportInjectReady:(unsigned int)arg1 path:(id)arg2 isPreload:(unsigned int)arg3;
- (void)reportInitReady:(unsigned int)arg1 path:(id)arg2 isPreload:(unsigned int)arg3 splashADState:(unsigned int)arg4 canShowLoadingAdvert:(_Bool)arg5;
- (void)endWithGameInteractive;
- (void)endWithUserScriptInjected;
- (void)endWithGetUrlReady:(unsigned int)arg1 ret:(unsigned int)arg2;
- (void)endWithPackageReady:(unsigned int)arg1 isPreload:(unsigned int)arg2 isParallelRequest:(_Bool)arg3;
- (id)getReportId;
...
- (void)registerOpenWeAppInfo:(id)arg1 appVersion:(long long)arg2 appState:(unsigned long long)arg3 scene:(unsigned long long)arg4 isPluginCode:(unsigned int)arg5 appServiceType:(unsigned long long)arg6;
- (id)init;
