...
@class CContact, ForwardMessageLogicController, MMAnimationTipView, MMHeadImageView, MMScrollView, NSMutableArray, NSMutableSet, NSString, RichTextView, ScanQRCodeLogicController, ShareDataToOpenSDKController, UIButton, UIImageView, UILabel, UIView, WCActionSheetWithScanWXCode, WCImageTranslateLogic, WCLikeButton;

@interface WCPhotoMutipleImageViewController : WCDragToCloseViewController <UIScrollViewDelegate, scrollViewDelegate, WCImageViewDelegate, WCActionSheetDelegate, WCFacadeExt, WCImageScrollViewDelegate, WCCommentDetailViewControllerFBDelegate, RichTextLayoutDelegate, BaseScanLogicDelegate>
{
