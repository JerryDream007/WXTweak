...
- (void)onOnceReturnAllDataWithRet:(int)arg1 andTip:(id)arg2;
...
- (_Bool)updateOnlySightAndPhotoTail;
- (_Bool)updateOnlySightAndPhotoHead;
- (void)beginHomepageOnlySightAndPhoto;
- (id)getHomepageData;
- (_Bool)updateTail;
