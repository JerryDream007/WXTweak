...
@class GPUImageDenosingBeauty, GPUImageNewBeautifyFilter, GPUImageRawDataInput, GPUImageSpatiotemporalDenosing, SpatiotemporalDenosingPreProcess;
...
- (_Bool)selectFilterType:(_Bool)arg1 IsSTDenoisingSupport:(_Bool)arg2 IsBackCameraData:(_Bool)arg3;
- (id)init:(_Bool)arg1 IsSTDenoisingSupport:(_Bool)arg2 IsBackCameraData:(_Bool)arg3;
