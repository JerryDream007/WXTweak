...
+ (void)setCanvasComponentItem:(id)arg1 byXmlNode:(struct XmlReaderNode_t *)arg2 withSizeType:(int)arg3 basicWidth:(int)arg4 basicRootFontSize:(int)arg5 widthRoundingType:(int)arg6 heightRoundingType:(int)arg7;
+ (void)setAdCanvasPage:(id)arg1 byXmlNode:(struct XmlReaderNode_t *)arg2 withSizeType:(int)arg3 basicWidth:(int)arg4 basicRootFontSize:(int)arg5 widthRoundingType:(int)arg6 heightRoundingType:(int)arg7;
