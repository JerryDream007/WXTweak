...
@class MMGrowTextView, NSMutableArray, NSString, UIButton, UIImage, UILabel, UIScrollView, UIView, WCFinderBannerView, WCFinderContact, WCFinderCreateUserConfig, WCFinderCreateUserViewModel;
@protocol WCFinderCreateUserViewControllerDelegate;

@interface WCFinderCreateUserViewController : MMUIViewController <MMImagePickerManagerDelegate, UITextViewDelegate, MMGrowTextViewDelegate, WCFinderVeirfyNameTipsViewControllerDelegate, WCFinderBannerViewDelegate, MMRegionPickerViewControllerDelegate>
{
    id <WCFinderCreateUserViewControllerDelegate> _delegate;
    unsigned long long _scene;
    WCFinderCreateUserConfig *_autoInputConfig;
...
@property(retain, nonatomic) WCFinderCreateUserConfig *autoInputConfig; // @synthesize autoInputConfig=_autoInputConfig;
