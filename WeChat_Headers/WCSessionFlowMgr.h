...
@class MemoryMappedKV, NSMutableArray, NSMutableDictionary, NSString, WCSessionDSLExecuter, WCSessionFlowConfiger, WCSessionFlowSessionInfo, WCSessionFlowStatItem;
...
- (void)checkAndFilterBusinessData:(id)arg1 withSessionConfiger:(id)arg2;
