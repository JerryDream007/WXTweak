...
@property(nonatomic) unsigned int axTicketAutoRetry; // @dynamic axTicketAutoRetry;
@property(nonatomic) unsigned int axTicketExpireTime; // @dynamic axTicketExpireTime;
