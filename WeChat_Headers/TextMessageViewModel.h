...
@class MessageInterceptReporter, NSArray, NSMutableArray, NSString, UIColor, UIFont;

@interface TextMessageViewModel : CommonMessageViewModel <RichTextLayoutDelegate, ISolitaireMgrExt>
{
