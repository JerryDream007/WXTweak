...
@class MidasIAPCache, MidasIapMonitorPersistance, MidasTimer, NSData, NSMutableArray, NSMutableDictionary, NSString, SKMutablePayment, SKProduct;

@interface MidasIapOrderInfo : NSObject
{
    _Bool isDepositGameCoin;
    _Bool _needGetPayResult;
    _Bool _shouldAppendBillNoInAppUserName;
    int productType;
    NSString *productId;
    NSString *amt;
    long long quantity;
    ...
    MidasTimer *_timer;
    NSMutableDictionary *_matchOrderQueryInfo;
}

@property(nonatomic) _Bool shouldAppendBillNoInAppUserName; // @synthesize shouldAppendBillNoInAppUserName=_shouldAppendBillNoInAppUserName;
@property(retain, nonatomic) NSMutableDictionary *matchOrderQueryInfo; // @synthesize matchOrderQueryInfo=_matchOrderQueryInfo;
...
- (void)setForReprovide:(_Bool)arg1;
- (void)reset;
- (id)init;
