...
- (unsigned long long)queryFinderDownloadedSizesWithClientID:(id)arg1;
...
- (_Bool)StartCronetFileDownload:(id)arg1 withUrl:(id)arg2 withSavePath:(id)arg3 withIPList:(id)arg4 withIsGzip:(_Bool)arg5 withFileType:(int)arg6;
