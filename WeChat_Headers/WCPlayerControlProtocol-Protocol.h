...
@class NSString, TPVideoFrameBuffer, UIImage, WCPlayerPlaybackInfo, WCPlayerView;
...
- (void)onVideoPlayFail:(unsigned long long)arg1 LocalizedErrorDes:(NSString *)arg2;
- (void)onVideoPause;
- (void)onVideoPlay;
